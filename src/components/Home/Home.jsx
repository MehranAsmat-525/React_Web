            ...
            <section id="home">
                ...
                <div className="container">
                    <div className="banner_outer">
                        <div className="col">
                            <h3 className="title">
                                WE PROMOTE Web <span>development</span>
                            </h3>
                            <p>
                            Web development is the art of crafting digital experiences that blend creativity and technical expertise, creating captivating websites that connect people across the globe.
                            </p>
                        ...
                        <div className="col">
                            <div className="sub_banner_image">
                                <img src="banner-img.jpg" alt="Banner_image" />
                            </div>
